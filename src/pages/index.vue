...
import { useDelete, useGet, usePost, usePut } from '@/compsables/axios-fetch'
...
<template>
  <div>
    <n-space>
      <n-button @click="onRequest1"> get </n-button>
      <n-button @click="onRequest2"> post </n-button>
      <n-button @click="onRequest3"> put </n-button>
      <n-button @click="onRequest4"> delete </n-button>
    </n-space>
  </div>
</template>
